...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT question7.id, question7.question, user_answers.answer FROM question7 LEFT JOIN user_answers ON question7.id=user_answers.question_id WHERE question LIKE '%$search%'");
} else {
    // get all question7 and answers from the database
    $result = mysqli_query($conn, "SELECT question7.id, question7.question, user_answers.answer FROM question7 LEFT JOIN user_answers ON question7.id=user_answers.question_id");
}
