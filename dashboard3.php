...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT question3.id, question3.question, user_answers.answer FROM question3 LEFT JOIN user_answers ON question3.id=user_answers.question_id WHERE question LIKE '%$search%'");
} else {
    // get all question3 and answers from the database
    $result = mysqli_query($conn, "SELECT question3.id, question3.question, user_answers.answer FROM question3 LEFT JOIN user_answers ON question3.id=user_answers.question_id");
}
