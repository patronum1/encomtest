...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT question2.id, question2.question, user_answers.answer FROM question2 LEFT JOIN user_answers ON question2.id=user_answers.question_id WHERE question LIKE '%$search%'");
} else {
    // get all question2 and answers from the database
    $result = mysqli_query($conn, "SELECT question2.id, question2.question, user_answers.answer FROM question2 LEFT JOIN user_answers ON question2.id=user_answers.question_id");
}
