...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT questions.id, questions.question, user_answers.answer FROM questions LEFT JOIN user_answers ON questions.id=user_answers.question_id WHERE question LIKE '%$search%' LIMIT $offset, $questions_per_page");
} else {
    $result = mysqli_query($conn, "SELECT questions.id, questions.question, user_answers.answer FROM questions LEFT JOIN user_answers ON questions.id=user_answers.question_id LIMIT $offset, $questions_per_page");
}
// Count the total number of questions in the database
$count_query = mysqli_query($conn, "SELECT COUNT(*) as total_questions FROM questions");
$count_result = mysqli_fetch_assoc($count_query);
$total_questions = $count_result['total_questions'];
