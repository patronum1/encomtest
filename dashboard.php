...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT questions.id, questions.question, user_answers.answer FROM questions LEFT JOIN user_answers ON questions.id=user_answers.question_id WHERE question LIKE '%$search%'");
} else {
    // get all questions and answers from the database
    $result = mysqli_query($conn, "SELECT questions.id, questions.question, user_answers.answer FROM questions LEFT JOIN user_answers ON questions.id=user_answers.question_id");
}
