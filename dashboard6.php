...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT question6.id, question6.question, user_answers.answer FROM question6 LEFT JOIN user_answers ON question6.id=user_answers.question_id WHERE question LIKE '%$search%'");
} else {
    // get all question6 and answers from the database
    $result = mysqli_query($conn, "SELECT question6.id, question6.question, user_answers.answer FROM question6 LEFT JOIN user_answers ON question6.id=user_answers.question_id");
}
