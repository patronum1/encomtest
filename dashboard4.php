...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT question4.id, question4.question, user_answers.answer FROM question4 LEFT JOIN user_answers ON question4.id=user_answers.question_id WHERE question LIKE '%$search%'");
} else {
    // get all question4 and answers from the database
    $result = mysqli_query($conn, "SELECT question4.id, question4.question, user_answers.answer FROM question4 LEFT JOIN user_answers ON question4.id=user_answers.question_id");
}
