...
if(isset($_GET['q'])) {
    $search = $_GET['q'];
    $result = mysqli_query($conn, "SELECT question5.id, question5.question, user_answers.answer FROM question5 LEFT JOIN user_answers ON question5.id=user_answers.question_id WHERE question LIKE '%$search%'");
} else {
    // get all question5 and answers from the database
    $result = mysqli_query($conn, "SELECT question5.id, question5.question, user_answers.answer FROM question5 LEFT JOIN user_answers ON question5.id=user_answers.question_id");
}
